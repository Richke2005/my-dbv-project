...
.get('/pathfinders/parents', (req, res) => pathfinderController.getPathfinderParents(req, res))
.get('/pathfinders/:id/parents', (req, res) => pathfinderController.getPathfinderParentsById(req, res))
